...
//    var searchViewModel = SearchViewModel.init(cells: [])
    ...
    @IBAction func playButtonAction(_ sender: UIButton) {
        tabBar.trackDetailView.delegate = self
...
//            delete(track: searchViewModel.cells[indexPath.row])
...
//        searchViewModel.cells.remove(at: myIndex)
          tracks.remove(at: track)
//        if let savedData = try? NSKeyedArchiver.archivedData(withRootObject: searchViewModel.cells,
        print(tracks.count)
...
//    searchViewModel.cells.remove(atOffsets: indexSet)
//    if let savedData = try? NSKeyedArchiver.archivedData(withRootObject: searchViewModel.cells, requiringSecureCoding: false) {
//            let defaults = UserDefaults.standard
//            defaults.setValue(savedData, forKey: UserDefaults.favouriteTrackKey)
//
////        refreshData()
