...
#ifndef IMUSIC_SWIFT_H
#define IMUSIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IMusic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6IMusic11AppDelegate")
...
SWIFT_CLASS("_TtC6IMusic10FooterView")
...
SWIFT_CLASS("_TtC6IMusic13SceneDelegate")
...
SWIFT_CLASS("_TtC6IMusic20SearchViewController")
...
@interface SearchViewController (SWIFT_EXTENSION(IMusic)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC6IMusic15SearchViewModel")
@interface SearchViewModel : NSObject <NSCoding>
...
@interface _TtCC6IMusic15SearchViewModel4Cell : NSObject <NSCoding>
- (void)encodeWithCoder:(NSCoder * _Nonnull)coder;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified addTrackButton;
+ (void)awakeFromNib;
- (void)prepareForReuse;
- (IBAction)addTrackAcion:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC6IMusic15TrackDetailView")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified durationTimeLabel;
...
@property (nonatomic, weak) IBOutlet UISlider * _Null_unspecified voluemSlider;
@property (nonatomic, weak) IBOutlet UIStackView * _Null_unspecified maximizedStackView;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified miniTrackPlayer;
...
- (IBAction)handleCurrentTimeSlider:(id _Nonnull)sender;
